...
function UESaveTool() {
    ...
    switch(mode) {
        case "-sav-to-json":
            //./uesavetool.js -sav-to-json D:\Wemade\Mir4Global\Mir4Client\MirMobile\SaveData\Saved\SaveGames\AccountLocalSave11.sav out.json
            ...
            break;
        case "-json-to-sav":
        //./uesavetool.js -json-to-sav  out.json out.sav
